...
class ScanController:
    ...
    # ---------------- merge + enrichment ----------------
    def _merge_nmap_with_existing(self, nmap_map: Dict[str, Dict[str, Any]], arp_map: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
        out: Dict[str, Dict[str, Any]] = {}
        ...
        for ip in all_ips:
            ...
            if n and a:
                ...
                out[ip] = {"ip": ip, "mac": mac, "vendor": vendor, "hostname": hostname, "source": src, "name": name, "type": typ}
            elif n:
                out[ip] = dict(n)
            elif a:
                out[ip] = dict(a)
